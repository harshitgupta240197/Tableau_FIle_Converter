...
class CustomTkinterApp:
    def __init__(self, root):
        ...
        self.root.geometry("550x350")  # Set window size
        ...
        # Load the image
        logo_image = Image.open('./Logo.png')  # Change this to the path of your logo image
    ...
    def create_widgets(self):
        ...
        logo_label.grid(row=0, column=0, columnspan=4, padx=10, pady=(20, 40))
